...
import { Twitter, MessageCircle, Wallet, ChevronDown, TrendingUp } from "lucide-react"
...
export default function Leaderboard() {
  ...
  useEffect(() => {
    ...
    checkPhantomWallet()
  }, [setPhantomWalletInstalled]) //Corrected useEffect dependency
  ...
  const handleSocialSubmit = async (nickname: string, walletAddress: string, socials: Record<string, string>) => {
    try {
      ...
      alert("Error saving socials: " + (error instanceof Error ? error.message : "Unknown error"));
    }
  }
                ...
                <div className="p-6 pt-8 relative">
                  ...
                  <div className="flex items-center justify-between mb-4 relative z-10">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-300">{trader.greenTrades} Wins</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="w-3 h-3 bg-red-400 rounded-full animate-pulse"></span>
                      <span className="text-sm text-gray-300">{trader.redTrades} Losses</span>
                    </div>
                  </div>
